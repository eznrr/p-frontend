<template>
    ...
    <img src="/public/foto-receita2.jpeg" alt="Imagem de uma receita"> 
      <form  @submit.prevent="submitForm">
        ...
        <button :disabled="isSubmitDisabled" type="submit" class="submit-button">Registrar</button>
        <p>Ja possui uma conta? <a href="" @click="goToLogin">Fazer login</a></p>
      </form>
